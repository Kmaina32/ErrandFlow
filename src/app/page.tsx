    ...
    <div className="flex min-h-screen w-full flex-col bg-background text-foreground">
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="lg:col-span-1 lg:order-2 order-1">
          <div className="relative min-h-[300px] lg:min-h-full h-full w-full rounded-lg lg:rounded-none overflow-hidden m-0 lg:p-0">
            ...
            <div className="relative flex h-full w-full items-center justify-center">
                  <div className="text-center lg:text-left text-white p-8 max-w-2xl w-full">
                      <h1 className="font-headline text-4xl md:text-5xl font-bold tracking-tighter">
                          Tumia Kazi, <span className="text-primary">Sorted</span>.
                      </h1>
                      <p className="max-w-[600px] text-md md:text-lg text-white/80 mt-4 mx-auto lg:mx-0">
                    ...
                    <div className="hidden lg:block mt-12 space-y-8">
                        <div className="flex items-start gap-4">
                            <Badge variant="outline" className="p-3 bg-primary/10 border-primary/20 text-primary">
                                <PencilLine className="h-6 w-6" />
                            </Badge>
                            <div>
                                <h3 className="font-semibold text-lg">1. Post Your Errand</h3>
                                <p className="text-white/70">Fill out the form with your details, what you need done, and where it needs to go.</p>
                            </div>
                        </div>
                         <div className="flex items-start gap-4">
                            <Badge variant="outline" className="p-3 bg-primary/10 border-primary/20 text-primary">
                            ...
                            <div>
                                ...
                                <p className="text-white/70">Our AI analyzes the task and gives you a fair, real-time price recommendation.</p>
                            </div>
                        </div>
                         <div className="flex items-start gap-4">
                            <Badge variant="outline" className="p-3 bg-primary/10 border-primary/20 text-primary">
                            ...
                            <div>
                                ...
                                <p className="text-white/70">Once submitted, your request is sent out and a nearby rider will pick it up.</p>
                            </div>
                        </div>
                    </div>
